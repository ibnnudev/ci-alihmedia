...
<div class="card mb-4">
    <div class="card-body">
        ...
        <form action="<?= base_url('admin/cases/store') ?>" method="POST">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="active_ri" name="active_ri" required>
                    </div>
                    <div class="mb-3">
                        <label for="inactive_ri" class="form-label">Masa Inaktif</label>
                        <input type="number" class="form-control" id="inactive_ri" name="inactive_ri" required>
                    </div>
                </div>
            </div>

...
<div class="card mb-4">
    <div class="card-body">
        ...
        <form action="<?= base_url('admin/retention-schedule/update/' . $data['id']) ?>" method="post">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="retention-date" class="form-label">Tanggal</label>
                        <input type="date" class="form-control" required id="retention-date" name="retention-date" value="<?= $data['retention_date'] ?>" />
                    </div>
                </div>
            </div>
